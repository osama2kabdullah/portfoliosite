  ...
  return (
    <div className="p-5 lg:w-3/5 w-5/5 mx-auto ">
      <div>
        ...
        <Link to='/detail/jerp' className="text-2xl cursor-pointer hover:text-gray-300 underline font-bold font-primary">
          The project title -{" "}
          <span className="italic text-title">A manufacturer company</span>
        </Link>
